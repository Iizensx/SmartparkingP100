  ...
  {filteredData.length > 0 ? (
    filteredData.map((record) => (
      ...
      >
        ...
        <div
          className={`record-summary ${expandedId === record.id ? "hidden" : ""}`}
        >
          <div className="record-details">
            <p className="record-date">{formatDateToThai(record.date)}</p>
        ...
        {expandedId === record.id && (
          <div className="record-expanded">
            <div className="daterecord">
              <p className="record-date2">{formatDateToThai(record.carDetails.date)}</p>
            </div>
