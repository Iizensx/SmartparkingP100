...
function Unsuccessful1({}) {
  ...
  const handleProfileClick = () => {
    if (location.pathname.includes("/payment") && location.pathname.includes("/unsuccessful")) {
          ...
          <div className="boxnav">
            <div className="bottom-navbar">
              <Nav className="justify-content-around">
                ...
                <Nav.Link
                  href="/SmartparkingT/findparking"
                ...
                <Nav.Link
                  href="/SmartparkingT/record"
                  className={`nav-item record-link ${
                    location.pathname === "/record" ? "active" : ""
                  }`}
                >
                  <FontAwesomeIcon icon={faBuildingCircleCheck} className='icon' style={{ fontSize: "31px" }} />
                  <span> ประวัติการจอด</span>
                </Nav.Link>
                <Nav.Link
                  href="/SmartparkingT/profile"
                ...
                >
                  <FontAwesomeIcon icon={faAddressCard} className='icon' style={{ fontSize: "31px" }} />
